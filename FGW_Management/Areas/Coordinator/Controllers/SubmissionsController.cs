...
namespace FGW_Management.Areas.Coordinator
{
    [Area("Coordinator")]
    public class SubmissionsController : Controller
    {
        ...
        // GET: Coordinator/Submissions/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Coordinator/Submissions/Create
        ...
        public async Task<IActionResult> Create( Submission submission)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    submission.SubmissionDue = DateTime.Now;
                ...
                ViewData["Error"] = "Deadline 2 is not accpetable.";
            }
            return View(submission);
        }

        // GET: Coordinator/Submissions/Edit/5
        ...
        // POST: Coordinator/Submissions/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Coordinator/Submissions/Delete/5
        ...
        // POST: Coordinator/Submissions/Delete/5
