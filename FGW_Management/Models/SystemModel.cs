...
namespace FGW_Management.Models
{
        ...
        //Topic
    {
        ...
        [Required(ErrorMessage = "Please enter submission due!")]
        [DisplayName("Submission Due")]
        [DisplayFormat(DataFormatString = "{0:MM/dd/yyyy}")]
        public DateTime SubmissionDue { get; set; }

        [Required(ErrorMessage = "Please enter deadline term 1!")]
        [DisplayName("Submission Date term 1")]
        [DisplayFormat(DataFormatString = "{0:MM/dd/yyyy}")]
        public DateTime SubmissionDeadline_1 { get; set; }

        [Required(ErrorMessage = "Please enter deadline term 2!")]
        [DisplayName("Submission Date term 2")]
        [DisplayFormat(DataFormatString = "{0:MM/dd/yyyy}")]
